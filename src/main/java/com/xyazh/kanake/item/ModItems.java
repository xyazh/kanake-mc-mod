...
public class ModItems {
    ...
    public static final Item TEST_ITEM = new ItemTestItem("test").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE = new ItemBase("rune").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_EMPTY = new ItemBase("rune_empty").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_FIRE_BALL = new ItemFireBallRune("rune_fire_ball").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_FIRE_BALL_LOOK_AT = new ItemFireBallLookAtRune("rune_fire_ball_look_at").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_ICE_BOLT = new ItemIceBoltRune("rune_ice_bolt").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_FIRE_CURSE = new ItemFireCurseRune("rune_fire_curse").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_ICE_FROST = new ItemIceFrostRune("rune_ice_frost").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_EXPLOSION = new ItemExplosionRune("rune_explosion").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_EXPLOSION_LOOK_AT = new ItemExplosionLookAtRune("rune_explosion_look_at").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_MAGIC = new ItemMagicRune("rune_magic").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_TP = new ItemTpRune("rune_tp").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item RUNE_BLOCKING_LOOK_AT = new ItemBlockingLookAtRune("rune_blocking_look_at").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    ...
    public static final Item HARMONIUM_CRYSTAL_AXE = new ItemHarmoniumCrystalAxe("harmonium_crystal_axe").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item HARMONIUM_CRYSTAL_HOE = new ItemHarmoniumCrystalHoe("harmonium_crystal_hoe").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item HARMONIUM_CRYSTAL_PICKAXE = new ItemHarmoniumCrystalPickaxe("harmonium_crystal_pickaxe").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item HARMONIUM_CRYSTAL_SHOVEL = new ItemHarmoniumCrystalSword("harmonium_crystal_shovel").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item HARMONIUM_CRYSTAL_SWORD = new ItemHarmoniumCrystalSword("harmonium_crystal_sword").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    ...
    public static final Item POTION_MP = new ItemPotionMp("potion_mp",40).setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item BOTTLE_SMALL = new ItemBase("bottle_small").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    ...
    public static final Item MONO_SP = new ItemMonoSP("mono_sp").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item MONO_SUB = new ItemBase("mono_sub").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
    public static final Item MONO_FRAME = new ItemBase("mono_frame").setCreativeTab(ModCreativeTab.SBW_CREATIVE);
