...
public class CommonDef {
    ...
    /**
     * Flag 1 will cause acceleration block update. Flag 2 will send the change to clients. Flag 4 will prevent the block from
     * being re-rendered, if this is acceleration client world. Flag 8 will force any re-renders to run on the main thread instead
     * of the worker pool, if this is acceleration client world and flag 4 is clear. Flag 16 will prevent observers from seeing
