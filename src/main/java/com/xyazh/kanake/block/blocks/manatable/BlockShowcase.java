...
public class BlockShowcase extends BlockManaTableBase{
    public BlockShowcase(String name, Material material, Class<? extends TileManaWithForeverEntity> tileEntityClass) {
    ...
    public TileEntity createNewTileEntity(@Nonnull World worldIn, int meta) {
        return new TileManaWithForeverEntity();
    }
