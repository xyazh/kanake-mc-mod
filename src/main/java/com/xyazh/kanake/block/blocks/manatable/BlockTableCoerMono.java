...
public class BlockTableCoerMono extends BlockTableMono{
    public BlockTableCoerMono(String name, Material material, Class<? extends TileManaWithForeverEntity> tileEntityClass) {
