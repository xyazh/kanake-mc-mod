...
public class RenderTileManaStorage extends TileEntitySpecialRenderer<TileManaStorage> {
    public RenderTileManaStorage() {
        super();
    }

    public boolean isGlobalRenderer(@Nonnull TileManaStorage te) {
        return false;
    }

    public void renderSquare(TileManaStorage te, BufferBuilder bufferbuilder, float partialTicks, double x, double y, double z, double size, int color) {
    ...
    public void render(TileManaStorage te, BufferBuilder bufferbuilder, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        renderSquare(te, bufferbuilder, partialTicks, x, y, z, 1.0, 0xAAFF00FF);
    }

    public void render(@Nonnull TileManaStorage te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
