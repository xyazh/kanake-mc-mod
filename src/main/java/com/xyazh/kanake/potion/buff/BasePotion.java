...
public class BasePotion extends BaseSimplePotion {
    private static final ResourceLocation resource = new ResourceLocation("space_based_weapon","textures/misc/potions.png");
...
//        setPotionName("space_based_weapon.potion." + name);
//        iconIndex = icon;
//    }
...
//    private void render(int x, int args, float alpha) {
...
//
//        buf.pos(x, args + 18, 0).tex(textureX * 0.00390625, (textureY + 18) * 0.00390625).endVertex();
//        buf.pos(x + 18, args + 18, 0).tex((textureX + 18) * 0.00390625, (textureY + 18) * 0.00390625).endVertex();
//        buf.pos(x + 18, args, 0).tex((textureX + 18) * 0.00390625, textureY * 0.00390625).endVertex();
//        buf.pos(x, args, 0).tex(textureX * 0.00390625, textureY * 0.00390625).endVertex();
//
//        tessellator.draw();
//    }
//
//    @Override
//    @SideOnly(Side.CLIENT)
//    public void renderInventoryEffect(int x, int args, PotionEffect effect, Minecraft mc) {
//        render(x + 6, args + 7, 1);
//    }
//
//    @Override
//    @SideOnly(Side.CLIENT)
//    public void renderHUDEffect(int x, int args, PotionEffect effect, Minecraft mc, float alpha) {
//        render(x + 3, args + 3, alpha);
//    }
}
