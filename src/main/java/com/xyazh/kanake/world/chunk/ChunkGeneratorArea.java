...
import com.xyazh.kanake.world.gen.WorldGenAreaIsland;
...
public class ChunkGeneratorArea implements IChunkGenerator
{
    ...
    double[] ar;
    double[] br;
    private final WorldGenAreaIsland islands = new WorldGenAreaIsland();
    private int chunkX = 0;
    private int chunkZ = 0;

    public ChunkGeneratorArea(World world, boolean mapFeaturesEnabled, long seed, BlockPos spawnPoint)
    {
        this.world = world;
            ...
            for (int j = 0; j < 16; ++j)
            {
                ...
                for (int i1 = 127; i1 >= 0; --i1)
                {
                    ...
                    else if (iblockstate2.getBlock() == Blocks.STONE)
                    {
                        ...
                        {
                            //--l;
                            primer.setBlockState(i, i1, j, STONE);
                        }
                    }
                }
            }
    ...
    private float getIslandHeightValue(int p_185960_1_, int p_185960_2_, int p_185960_3_, int p_185960_4_)
    {
        ...
        for (int i = -12; i <= 12; ++i)
        {
            for (int j = -12; j <= 12; ++j)
            {
                ...
                if (k * k + l * l > 1024L && this.islandNoise.getValue((double)k, (double)l) < -0.8999999761581421D)
                {
    ...
    {
        return (long)p_185961_1_ * (long)p_185961_1_ + (long)p_185961_2_ * (long)p_185961_2_ > 1024L && this.getIslandHeightValue(p_185961_1_, p_185961_2_, 1, 1) >= 0.0F;
    }
    ...
    public void populate(int x, int z)
    {
        ...
        if (i > 1024L)
        {
            ...
            {
                this.islands.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(16) + 8, 55 + this.rand.nextInt(16), this.rand.nextInt(16) + 8));
